...
public class Database : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        skillDB.Add("PROJ0001", new Projectile("Basic Projectile", "EXAMPLE DESCRIPTION", "URL", 0, "Assets/Prefabs/Projectile/PROJ0001.prefab", 5, 2, 1, 30));
        skillDB.Add("AREA0001", new AOE("HEAVENLY STRIKE", "Call upon divine power to bring down a massive sword# targeting a specific area. Dealing massive damage to all enemies within the impact zone.", "URL", "Assets/Art Assets/Shikashi's Fantasy Icons Pack v2/Shikashi's Fantasy Icons Pack v2/TextExplosion.prefab", 1, 7, 3));
